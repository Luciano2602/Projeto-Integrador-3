...
namespace FrmLogin
{
    public partial class FrmPedidoConsultarExcluir : Form
    {
        public FrmPedidoConsultarExcluir()
        {
            InitializeComponent();
        }
        ...
        private void FrmPedidoConsultarExcluir_Load(object sender, EventArgs e)
        {
