...
namespace FrmLogin
{
    public partial class FrmPedidoAlterarCadastrar : Form
    {
        
        public FrmPedidoAlterarCadastrar()
        {
            InitializeComponent();
        }
        ...
        private void FrmPedidoAlterarCadastrar_Load(object sender, EventArgs e)
        {
